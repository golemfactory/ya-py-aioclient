...
T = TypeVar('T', bound='InvoiceAcceptedEvent')


@dataclass
class InvoiceAcceptedEvent:
    """
    Attributes:
        event_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_accepted_event = cls(
            event_type=event_type,
            event_date=event_date,
            invoice_id=invoice_id,
        )

        invoice_accepted_event.additional_properties = d
        return invoice_accepted_event
