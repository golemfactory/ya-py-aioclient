...
T = TypeVar('T', bound='InvoicePaymentOkEvent')


@dataclass
class InvoicePaymentOkEvent:
    """
    Attributes:
        event_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        invoice_payment_ok_event = cls(
            event_type=event_type,
            event_date=event_date,
            invoice_id=invoice_id,
        )

        invoice_payment_ok_event.additional_properties = d
        return invoice_payment_ok_event
