...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/payment-api/v1/debitNotes/{debit_note_id}/reject".format(
...
def sync_detailed(
    ...
    *,
    ...
    Send Debit Note Rejected message to Invoice Issuer. Notification of rejection is signalling that
    Requestor does not accept the Debit Note (for some reason).
