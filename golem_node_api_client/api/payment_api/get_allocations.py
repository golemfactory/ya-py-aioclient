...
) -> Optional[Union[ErrorMessage, List['Allocation']]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = Allocation.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorMessage, List['Allocation']]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorMessage, List['Allocation']]
    """
