...
class ProviderApi(object):
    ...
    def terminate_agreement(self, agreement_id, **kwargs):  # noqa: E501
        ...
        Method to finish/close the Agreement while in `Approved` state. The other party gets notified about calling party decision to terminate a \"running\" agreement. **Note**: Can be invoked at any time after Agreement was approved by both sides. Financial and reputational consequences are not defined by this specification.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
