...
class DeployNetwork(object):
    _id: str  # readonly: False
    ip: str  # readonly: False
    mask: str  # readonly: False
...
class DeployCommandBody(object):
    net: Optional[list]  # readonly: False
    hosts: dict  # readonly: False
    nodes: dict  # readonly: False
...
class DeployCommandAllOf(ExeScriptCommand):
    deploy: DeployCommandBody  # readonly: False

    def __init__(self,
        deploy: DeployCommandBody = None
    ) -> None: ...
    def to_dict(self) -> dict: ...
